...
- `queries/highlights.scm` - Syntax highlighting rules using Tree-sitter query patterns
- `queries/locals.scm` - Scope analysis for go-to-definition
...
1. Update `queries/highlights.scm` if adding new node types
